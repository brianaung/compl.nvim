...
#### Planned Features
- Support for custom completion sources via minimal LSP servers (using the same principles as the snippets support).
  - **Note:** Compatibility layer for `nvim-cmp`'s custom sources may or may not be implemented.
